...
library Bn128 {
    ...
    function public_poly_eval(G1Point[] calldata coefficients, uint256 index) internal view returns (G1Point memory) {
        uint256 xi = index;
    ...
    function g1Equal(G1Point memory p1, G1Point memory p2) internal view returns (bool) {
